            ...
            <div className="grid md:grid-cols-3 gap-6 my-10">
                {
                    classes.slice(0, 6).map(item => <>
                        <div className={item.seats === 0 ? 'bg-red-600 h-full rounded-lg text-white  flex flex-col items-start  hover:scale-105' : 'bg-bage-100 flex flex-col items-start rounded-lg  pb-5 hover:scale-105'} style={{ transition: '0.5s' }}>
